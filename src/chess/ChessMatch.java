...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (movedPiece instanceof Pawn) {
			if ((movedPiece.getColor() == Color.CYAN && target.getRow() == 0)
					|| (movedPiece.getColor() == Color.PURPLE && target.getRow() == 7)) {
	...
	private void initialSetup() {
		...
		placeNewPiece('d', 1, new King(board, Color.CYAN, this));
		placeNewPiece('e', 1, new Queen(board, Color.CYAN));
		...
		placeNewPiece('d', 8, new King(board, Color.PURPLE, this));
		placeNewPiece('e', 8, new Queen(board, Color.PURPLE));
